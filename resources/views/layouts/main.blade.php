...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <!--
            `data-turbolinks-track reload` makes sure to fetch updated app.js when it is changed
            Use together with asset versioning: https://laravel-mix.com/docs/6.0/versioning
        -->
